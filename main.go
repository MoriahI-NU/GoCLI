...
func main() {
	var rootCmd = &cobra.Command{Use: "housing_stats"}
	...
	var calculateCmd = &cobra.Command{
		Use:   "calculate",
		Short: "Calculate summary Statistics",
		Run:   calculateSummaryStatistics,
	}
...
func calculateSummaryStatistics(cmd *cobra.Command, args []string) {
